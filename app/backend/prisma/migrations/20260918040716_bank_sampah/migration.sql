...
-- CreateEnum
CREATE TYPE "StatusSetor" AS ENUM ('menunggu_konfirmasi', 'diverifikasi', 'selesai', 'ditolak');

-- CreateEnum
CREATE TYPE "StatusPenukaran" AS ENUM ('diproses', 'selesai');

-- CreateEnum
CREATE TYPE "MediaKind" AS ENUM ('nasabah_foto', 'kategori_foto', 'hadiah_foto');
...
CREATE TABLE "setor_sampah" (
    ...
    "kode_setor" VARCHAR(20) NOT NULL,
    "catatan" TEXT,
    "catatan_admin" TEXT,
    "total_berat_kg" DECIMAL(14,3) NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "media_tenant_id_kind_owner_id_idx" ON "media"("tenant_id", "kind", "owner_id");

-- CreateIndex
CREATE INDEX "media_tenant_id_deleted_at_idx" ON "media"("tenant_id", "deleted_at");
